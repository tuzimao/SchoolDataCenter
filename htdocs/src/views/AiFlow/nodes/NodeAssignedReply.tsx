...
const NodeAssignedReply = ({ data, selected }: NodeProps<FlowModuleItemType>) => {
  ...
  console.log("NodeAssignedReply moduleId", selected, id, name, moduleId, inputs, outputs)
  console.log("NodeAssignedReply data", data)
...
export default React.memo(NodeAssignedReply);
