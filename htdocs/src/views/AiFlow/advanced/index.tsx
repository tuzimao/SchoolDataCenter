...
import NodeSimple from 'src/views/AiFlow/nodes/NodeSimple';
import NodeQuestionInput from 'src/views/AiFlow/nodes/NodeQuestionInput';
import NodeUserGuide from 'src/views/AiFlow/nodes/NodeUserGuide';
import NodeChatNode from 'src/views/AiFlow/nodes/NodeChatNode';
import NodeAssignedReply from 'src/views/AiFlow/nodes/NodeAssignedReply';
import NodeClassifyQuestion from 'src/views/AiFlow/nodes/NodeClassifyQuestion';
import NodeContentExtract from 'src/views/AiFlow/nodes/NodeContentExtract';
import NodeHttpRequest from 'src/views/AiFlow/nodes/NodeHttpRequest';
