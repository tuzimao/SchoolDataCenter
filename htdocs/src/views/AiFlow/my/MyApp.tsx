...
import NewApp from 'src/views/AiFlow/my/NewApp'
import MyAppModel from 'src/views/AiFlow/my/MyAppModel'
import MyAppDelete from 'src/views/AiFlow/my/MyAppDelete'
...
const MyApp = () => {
  ...
  const handleAddApp = async () => {
    ...
    if (auth && auth.user) {
      ...
      const FormSubmit: any = await axios.post(authConfig.backEndApiHost + '/api/addapp', PostParams, { headers: { Authorization: 'auth.user?.token', 'Content-Type': 'application/json'} }).then(res => res.data)
