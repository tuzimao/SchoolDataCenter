...
const AddEventSidebar = (props: AddEventSidebarType) => {
  // Props
  const { calendarStore, addEventSidebarOpen, handleAddEventSidebarToggle } = props
          ...
          <form onSubmit={handleSubmit(onSubmit)} autoComplete='off'>
            ...
            <div className='mbe-6'>
              <AppReactDatepicker
                ...
                onChange={(date: Date | null) => {
                  if (date) setValues({ ...values, startDate: new Date(date) });
                }}
            ...
            <div className='mbe-6'>
              <AppReactDatepicker
                ...
                onChange={(date: Date | null) => {
                  if (date) setValues({ ...values, endDate: new Date(date) });
                }}
              />
            </div>
